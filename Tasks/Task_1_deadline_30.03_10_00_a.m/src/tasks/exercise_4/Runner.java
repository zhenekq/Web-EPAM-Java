...
public class Runner {
    public static void main(String[] args){
        ...
        boolean isMoreThanTwo =
                CheckNumbers.isEvenNumberMoreThanTwo(
                        CheckNumbers.isNumberEven(firstNumber),
        ...
        if(isMoreThanTwo)
            System.out.println("Amount of even numbers are equals or more than 2: " +
                                true
            );
        else
            System.out.println("Amount of even numbers are equals or more than 2: " +
