package by.epamtc.task.exercise7.runner;

import by.epamtc.task.ReadNumber;
import by.epamtc.task.exercise7.util.MathOperations;
...
public class Runner {
    public static void main(String[] args) {
        ...
        }else if(lengthOfFirstPoint == lengthOfSecondPoint){
            System.out.println("Points have identy distance");
        }
        else {
